        ...
        <div className="min-h-screen flex bg-white dark:bg-gray-900">
            ...
            <div className="hidden lg:flex w-1/2 bg-blue-600 relative overflow-hidden items-center justify-center">
                <div className="absolute inset-0 bg-blue-600">
                    ...
                    <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-cyan-400 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000" />
                </div>
                ...
                <div className="relative z-10 text-center p-12 text-white max-w-lg">
                    ...
                    <h1 className="text-4xl font-bold mb-6 leading-tight">
                        ...
                        <span className="text-blue-200">Aksara AI</span>
                    </h1>
                    <p className="text-lg text-blue-100 leading-relaxed">
                        Asisten cerdas untuk membantu produktivitas dan kreativitas Anda. Masuk untuk mulai berinteraksi.
                    </p>
                </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white dark:bg-gray-900">
                <div className="w-full max-w-md">
                    <div className="text-center mb-12">
                        ...
                        <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Login Akun</h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                required
                                className="w-full px-5 py-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white placeholder:text-gray-400 focus:border-blue-500 focus:ring-0 outline-none transition-all"
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <Link href="/forgot-password" target="_blank" className="text-sm text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-medium transition-colors">
                                    Lupa Password?
                                </Link>
                            </div>
                            <div className="relative">
                                <input
                                    ...
                                    required
                                    className="w-full px-5 py-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white placeholder:text-gray-400 focus:border-blue-500 focus:ring-0 outline-none transition-all pr-14"
                                    placeholder="••••••••"
                                />
                                <button
                                    type="button"
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-4 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold tracking-wide transition-all disabled:opacity-50 shadow-lg shadow-blue-500/20 transform hover:-translate-y-0.5"
                        >
                    ...
                    <p className="text-center mt-8 text-gray-500 dark:text-gray-400 font-medium">
                        Belum punya akun?{' '}
                        <Link href="/register" className="text-blue-600 dark:text-blue-400 font-bold hover:underline transition-all">
                            Daftar Gratis
                        </Link>
                    </p>
                </div>
