        ...
        <div className="min-h-screen flex items-center justify-center bg-[var(--background)] px-4 py-8">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-[var(--text-primary)]">Buat Akun Baru</h1>
                    <p className="text-[var(--text-secondary)] mt-1">Bergabung dengan Aksara AI</p>
                </div>
                ...
                <button
                    ...
                    disabled={loading}
                    className="w-full flex items-center justify-center gap-3 py-3 rounded-xl border border-[var(--border)] bg-[var(--surface)] hover:bg-[var(--sidebar-hover)] transition-colors disabled:opacity-50 mb-6"
                >
                    ...
                    <span className="font-medium text-[var(--text-primary)]">Daftar dengan Google</span>
                </button>
                ...
                <div className="relative mb-6">
                    ...
                    <div className="relative flex justify-center text-sm">
                        <span className="px-4 bg-[var(--background)] text-[var(--text-secondary)]">atau</span>
                    </div>
                </div>
