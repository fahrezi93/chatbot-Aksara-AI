                    ...
                    {isOpen && (
                        <div className="relative group">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-9 py-2.5 bg-gray-100 dark:bg-gray-800/50 border border-transparent focus:border-blue-500/50 focus:bg-white dark:focus:bg-gray-900 focus:ring-4 focus:ring-blue-500/10 rounded-xl text-sm transition-all outline-none"
                            />
                            {searchQuery && (
                                <button
                            ...
                            <div className="space-y-1">
                                ...
                                {searchQuery && conversations.filter(c => c.title.toLowerCase().includes(searchQuery.toLowerCase())).length === 0 && (
                                    <div className="flex flex-col items-center justify-center py-12 text-center">
                                        ...
                                        <p className="text-sm text-gray-400 dark:text-gray-500">Tidak ada hasil untuk</p>
                                        <p className="text-sm font-medium text-gray-500 dark:text-gray-400 mt-1">&ldquo;{searchQuery}&rdquo;</p>
                                    </div>
                                )}
